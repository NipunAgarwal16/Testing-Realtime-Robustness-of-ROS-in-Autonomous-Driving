...
def ArUco_Pose_Estimation():
    ...
    while time.perf_counter() - timer <= 10:
        ...
        if ids is not None:  # when the drone detect something
            ...
            cv2.putText(
                frame, str_position, (0, 40), font, 1, (0, 255, 0), 2, cv2.LINE_AA
            )
            ...
            cv2.putText(
                frame, str_attitude, (0, 20), font, 1, (0, 255, 0), 2, cv2.LINE_AA
            )
            ...
            cv2.putText(
                frame, str_position, (0, 80), font, 1, (0, 255, 0), 2, cv2.LINE_AA
            )
            ...
            cv2.putText(
                frame, str_attitude, (0, 60), font, 1, (0, 255, 0), 2, cv2.LINE_AA
            )
